...
public class AdminMenu implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            loadAnchorPane.getChildren().add((Node)FXMLLoader.load(getClass().getResource("AdminRestaurant.fxml")));
        ...
        reservationButton.setOnAction(e->{
            try {
                loadAnchorPane.getChildren().clear();
                loadAnchorPane.getChildren().add((Node)FXMLLoader.load(getClass().getResource("AdminReservation.fxml")));
            } catch (IOException ioException) {
                ioException.printStackTrace();
            }
        });
